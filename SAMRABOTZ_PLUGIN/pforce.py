...
async def check_fsub(client, user_id):
    ...
    for x in target_channels:
        ...
        try:
            ...
            if member.status not in [enums.ChatMemberStatus.MEMBER, enums.ChatMemberStatus.ADMINISTRATOR, enums.ChatMemberStatus.OWNER]: raise UserNotParticipant()
            ...
            except Exception: error_status = "not_admin"
        except Exception as e:
            if "chat_admin_required" in str(e).lower(): error_status = "not_admin"
